...
/**
 * Returns the computation of a logical AND on all the values contained in the
 ...
 */
public class And implements AggregOperator<Boolean, List<Boolean>> {
	 ...
	 * AND of all values is returned.
	 * 
	 * @param future
	 *            Vector of candidate values.
	 * @return The logical AND of all the values contained in the argument
	 *         vector.
	 */
