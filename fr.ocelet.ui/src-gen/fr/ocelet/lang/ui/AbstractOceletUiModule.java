...
/**
 * Manual modifications go to {fr.ocelet.lang.ui.OceletUiModule}
 */
@SuppressWarnings("all")
public abstract class AbstractOceletUiModule extends org.eclipse.xtext.xbase.ui.DefaultXbaseUiModule {
	
	public AbstractOceletUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.HIGHLIGHTING)).to(fr.ocelet.lang.parser.antlr.internal.InternalOceletLexer.class);
	}
	...
	public Class<? extends org.eclipse.jface.viewers.ILabelProvider> bindILabelProvider() {
		return fr.ocelet.lang.ui.labeling.OceletLabelProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.labeling.LabelProviderFragment
	public void configureResourceUIServiceLabelProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.jface.viewers.ILabelProvider.class).annotatedWith(org.eclipse.xtext.ui.resource.ResourceServiceDescriptionLabelProvider.class).to(fr.ocelet.lang.ui.labeling.OceletDescriptionLabelProvider.class);
	}

	// contributed by org.eclipse.xtext.ui.generator.outline.OutlineTreeProviderFragment
	public Class<? extends org.eclipse.xtext.ui.editor.outline.IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return fr.ocelet.lang.ui.outline.OceletOutlineTreeProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.quickfix.IssueResolutionProvider> bindIssueResolutionProvider() {
		return fr.ocelet.lang.ui.quickfix.OceletQuickfixProvider.class;
	}

	// contributed by org.eclipse.xtext.ui.generator.contentAssist.ContentAssistFragment
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return fr.ocelet.lang.ui.contentassist.OceletProposalProvider.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return fr.ocelet.lang.ui.contentassist.antlr.OceletParser.class;
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletLexer.class).toProvider(org.eclipse.xtext.parser.antlr.LexerProvider.create(fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletLexer.class));
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.LexerUIBindings.CONTENT_ASSIST)).to(fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.codetemplates.ui.partialEditing.IPartialContentAssistParser> bindIPartialContentAssistParser() {
		return fr.ocelet.lang.ui.contentassist.antlr.PartialOceletContentAssistParser.class;
	}
