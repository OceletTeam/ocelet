 ...
 * generated by Xtext
 */
package fr.ocelet.lang.ui.contentassist.antlr;
...
public class OceletParser extends AbstractContentAssistParser {
	...
	@Override
	protected fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletParser createParser() {
		fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletParser result = new fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getModElnAccess().getAlternatives(), "rule__ModEln__Alternatives");
					put(grammarAccess.getParampartAccess().getAlternatives(), "rule__Parampart__Alternatives");
					put(grammarAccess.getParamdefaAccess().getPardefaAlternatives_1_0(), "rule__Paramdefa__PardefaAlternatives_1_0");
					put(grammarAccess.getEntityElementsAccess().getAlternatives(), "rule__EntityElements__Alternatives");
					put(grammarAccess.getRelElementsAccess().getAlternatives(), "rule__RelElements__Alternatives");
					put(grammarAccess.getComitexprAccess().getAlternatives_3(), "rule__Comitexpr__Alternatives_3");
					put(grammarAccess.getStrucElnAccess().getAlternatives(), "rule__StrucEln__Alternatives");
					put(grammarAccess.getDatafacerAccess().getAlternatives_3(), "rule__Datafacer__Alternatives_3");
					...
					put(grammarAccess.getXVariableDeclarationAccess().getWriteableAlternatives_1_0_0(), "rule__XVariableDeclaration__WriteableAlternatives_1_0_0");
					put(grammarAccess.getXVariableDeclarationAccess().getAlternatives_1_1(), "rule__XVariableDeclaration__Alternatives_1_1");
					...
					put(grammarAccess.getMetadataAccess().getGroup_3(), "rule__Metadata__Group_3__0");
					put(grammarAccess.getMetadataAccess().getGroup_4(), "rule__Metadata__Group_4__0");
					...
					put(grammarAccess.getServiceDefAccess().getGroup_4(), "rule__ServiceDef__Group_4__0");
					put(grammarAccess.getServiceDefAccess().getGroup_4_1(), "rule__ServiceDef__Group_4_1__0");
					put(grammarAccess.getConstructorDefAccess().getGroup(), "rule__ConstructorDef__Group__0");
					put(grammarAccess.getConstructorDefAccess().getGroup_3(), "rule__ConstructorDef__Group_3__0");
					put(grammarAccess.getConstructorDefAccess().getGroup_3_1(), "rule__ConstructorDef__Group_3_1__0");
					...
					put(grammarAccess.getRelPropertyDefAccess().getGroup(), "rule__RelPropertyDef__Group__0");
					put(grammarAccess.getInteractionDefAccess().getGroup(), "rule__InteractionDef__Group__0");
					put(grammarAccess.getInteractionDefAccess().getGroup_3(), "rule__InteractionDef__Group_3__0");
					put(grammarAccess.getInteractionDefAccess().getGroup_3_1(), "rule__InteractionDef__Group_3_1__0");
					put(grammarAccess.getInteractionDefAccess().getGroup_6(), "rule__InteractionDef__Group_6__0");
					put(grammarAccess.getComitexprAccess().getGroup(), "rule__Comitexpr__Group__0");
					put(grammarAccess.getFilterdefAccess().getGroup(), "rule__Filterdef__Group__0");
					put(grammarAccess.getFilterdefAccess().getGroup_3(), "rule__Filterdef__Group_3__0");
					put(grammarAccess.getFilterdefAccess().getGroup_3_1(), "rule__Filterdef__Group_3_1__0");
					put(grammarAccess.getStrucdefAccess().getGroup(), "rule__Strucdef__Group__0");
					put(grammarAccess.getStrucdefAccess().getGroup_2(), "rule__Strucdef__Group_2__0");
					put(grammarAccess.getStrucdefAccess().getGroup_3(), "rule__Strucdef__Group_3__0");
					put(grammarAccess.getStrucVarDefAccess().getGroup(), "rule__StrucVarDef__Group__0");
					put(grammarAccess.getStrucFuncDefAccess().getGroup(), "rule__StrucFuncDef__Group__0");
					put(grammarAccess.getStrucFuncDefAccess().getGroup_4(), "rule__StrucFuncDef__Group_4__0");
					put(grammarAccess.getStrucFuncDefAccess().getGroup_4_1(), "rule__StrucFuncDef__Group_4_1__0");
					put(grammarAccess.getDatafacerAccess().getGroup(), "rule__Datafacer__Group__0");
					put(grammarAccess.getDatafacerAccess().getGroup_6(), "rule__Datafacer__Group_6__0");
					put(grammarAccess.getDatafacerAccess().getGroup_6_1(), "rule__Datafacer__Group_6_1__0");
					...
					put(grammarAccess.getModelAccess().getModelnsAssignment_1(), "rule__Model__ModelnsAssignment_1");
					put(grammarAccess.getMetadataAccess().getDescAssignment_3_1(), "rule__Metadata__DescAssignment_3_1");
					put(grammarAccess.getMetadataAccess().getWebpAssignment_4_1(), "rule__Metadata__WebpAssignment_4_1");
					put(grammarAccess.getMetadataAccess().getParamdefsAssignment_5(), "rule__Metadata__ParamdefsAssignment_5");
					put(grammarAccess.getParameterAccess().getPtypeAssignment_1(), "rule__Parameter__PtypeAssignment_1");
					...
					put(grammarAccess.getEntityAccess().getEntelnsAssignment_3(), "rule__Entity__EntelnsAssignment_3");
					put(grammarAccess.getPropertyDefAccess().getTypeAssignment_1(), "rule__PropertyDef__TypeAssignment_1");
					put(grammarAccess.getPropertyDefAccess().getNameAssignment_2(), "rule__PropertyDef__NameAssignment_2");
					put(grammarAccess.getServiceDefAccess().getTypeAssignment_1(), "rule__ServiceDef__TypeAssignment_1");
					put(grammarAccess.getServiceDefAccess().getNameAssignment_2(), "rule__ServiceDef__NameAssignment_2");
					put(grammarAccess.getServiceDefAccess().getParamsAssignment_4_0(), "rule__ServiceDef__ParamsAssignment_4_0");
					put(grammarAccess.getServiceDefAccess().getParamsAssignment_4_1_1(), "rule__ServiceDef__ParamsAssignment_4_1_1");
					put(grammarAccess.getServiceDefAccess().getBodyAssignment_6(), "rule__ServiceDef__BodyAssignment_6");
					put(grammarAccess.getConstructorDefAccess().getNameAssignment_1(), "rule__ConstructorDef__NameAssignment_1");
					put(grammarAccess.getConstructorDefAccess().getParamsAssignment_3_0(), "rule__ConstructorDef__ParamsAssignment_3_0");
					put(grammarAccess.getConstructorDefAccess().getParamsAssignment_3_1_1(), "rule__ConstructorDef__ParamsAssignment_3_1_1");
					put(grammarAccess.getConstructorDefAccess().getBodyAssignment_5(), "rule__ConstructorDef__BodyAssignment_5");
					put(grammarAccess.getRelationAccess().getNameAssignment_1(), "rule__Relation__NameAssignment_1");
					put(grammarAccess.getRelationAccess().getRolesAssignment_3(), "rule__Relation__RolesAssignment_3");
					put(grammarAccess.getRelationAccess().getRolesAssignment_5(), "rule__Relation__RolesAssignment_5");
					put(grammarAccess.getRelationAccess().getRolesAssignment_6_1(), "rule__Relation__RolesAssignment_6_1");
					put(grammarAccess.getRelationAccess().getRelelnsAssignment_9(), "rule__Relation__RelelnsAssignment_9");
					put(grammarAccess.getRoleAccess().getTypeAssignment_0(), "rule__Role__TypeAssignment_0");
					put(grammarAccess.getRoleAccess().getNameAssignment_1(), "rule__Role__NameAssignment_1");
					put(grammarAccess.getRelPropertyDefAccess().getTypeAssignment_1(), "rule__RelPropertyDef__TypeAssignment_1");
					put(grammarAccess.getRelPropertyDefAccess().getNameAssignment_2(), "rule__RelPropertyDef__NameAssignment_2");
					put(grammarAccess.getInteractionDefAccess().getNameAssignment_1(), "rule__InteractionDef__NameAssignment_1");
					put(grammarAccess.getInteractionDefAccess().getParamsAssignment_3_0(), "rule__InteractionDef__ParamsAssignment_3_0");
					put(grammarAccess.getInteractionDefAccess().getParamsAssignment_3_1_1(), "rule__InteractionDef__ParamsAssignment_3_1_1");
					put(grammarAccess.getInteractionDefAccess().getBodyAssignment_5(), "rule__InteractionDef__BodyAssignment_5");
					put(grammarAccess.getInteractionDefAccess().getComitexpressionsAssignment_6_2(), "rule__InteractionDef__ComitexpressionsAssignment_6_2");
					put(grammarAccess.getComitexprAccess().getRolAssignment_0(), "rule__Comitexpr__RolAssignment_0");
					put(grammarAccess.getComitexprAccess().getPropAssignment_2(), "rule__Comitexpr__PropAssignment_2");
					put(grammarAccess.getComitexprAccess().getUseprevalAssignment_3_0(), "rule__Comitexpr__UseprevalAssignment_3_0");
					put(grammarAccess.getComitexprAccess().getAgrfuncAssignment_4(), "rule__Comitexpr__AgrfuncAssignment_4");
					put(grammarAccess.getFilterdefAccess().getNameAssignment_1(), "rule__Filterdef__NameAssignment_1");
					put(grammarAccess.getFilterdefAccess().getParamsAssignment_3_0(), "rule__Filterdef__ParamsAssignment_3_0");
					put(grammarAccess.getFilterdefAccess().getParamsAssignment_3_1_1(), "rule__Filterdef__ParamsAssignment_3_1_1");
					put(grammarAccess.getFilterdefAccess().getBodyAssignment_5(), "rule__Filterdef__BodyAssignment_5");
					put(grammarAccess.getStrucdefAccess().getNameAssignment_1(), "rule__Strucdef__NameAssignment_1");
					put(grammarAccess.getStrucdefAccess().getTypeArgumentAssignment_2_1(), "rule__Strucdef__TypeArgumentAssignment_2_1");
					put(grammarAccess.getStrucdefAccess().getSuperTypeAssignment_3_1(), "rule__Strucdef__SuperTypeAssignment_3_1");
					put(grammarAccess.getStrucdefAccess().getStrucelnsAssignment_5(), "rule__Strucdef__StrucelnsAssignment_5");
					put(grammarAccess.getStrucVarDefAccess().getTypeAssignment_0(), "rule__StrucVarDef__TypeAssignment_0");
					put(grammarAccess.getStrucVarDefAccess().getNameAssignment_1(), "rule__StrucVarDef__NameAssignment_1");
					put(grammarAccess.getStrucFuncDefAccess().getTypeAssignment_1(), "rule__StrucFuncDef__TypeAssignment_1");
					put(grammarAccess.getStrucFuncDefAccess().getNameAssignment_2(), "rule__StrucFuncDef__NameAssignment_2");
					put(grammarAccess.getStrucFuncDefAccess().getParamsAssignment_4_0(), "rule__StrucFuncDef__ParamsAssignment_4_0");
					put(grammarAccess.getStrucFuncDefAccess().getParamsAssignment_4_1_1(), "rule__StrucFuncDef__ParamsAssignment_4_1_1");
					put(grammarAccess.getStrucFuncDefAccess().getBodyAssignment_6(), "rule__StrucFuncDef__BodyAssignment_6");
					put(grammarAccess.getDatafacerAccess().getNameAssignment_1(), "rule__Datafacer__NameAssignment_1");
					put(grammarAccess.getDatafacerAccess().getStoretypeAssignment_4(), "rule__Datafacer__StoretypeAssignment_4");
					put(grammarAccess.getDatafacerAccess().getArgumentsAssignment_6_0(), "rule__Datafacer__ArgumentsAssignment_6_0");
					put(grammarAccess.getDatafacerAccess().getArgumentsAssignment_6_1_1(), "rule__Datafacer__ArgumentsAssignment_6_1_1");
					put(grammarAccess.getDatafacerAccess().getMatchboxAssignment_8(), "rule__Datafacer__MatchboxAssignment_8");
					put(grammarAccess.getMatchAccess().getMtypeAssignment_1(), "rule__Match__MtypeAssignment_1");
					put(grammarAccess.getMatchAccess().getMatchpropsAssignment_3(), "rule__Match__MatchpropsAssignment_3");
					put(grammarAccess.getMdefAccess().getPropAssignment_0(), "rule__Mdef__PropAssignment_0");
					put(grammarAccess.getMdefAccess().getColnameAssignment_2(), "rule__Mdef__ColnameAssignment_2");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletParser typedParser = (fr.ocelet.lang.ui.contentassist.antlr.internal.InternalOceletParser) parser;
